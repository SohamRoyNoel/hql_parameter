...
public class ClientApp {
	...
	public static void main(String[] args) {
		...
		//String hql="from Employee where ejob=:v_ejob";
		String hql="from Employee where ejob=:v_ejob and esal>:v_esal"; //esal = column_name @ the class
		Query query=session.createQuery(hql);
		query.setParameter("v_ejob","Manager");
		query.setParameter("v_esal",12000.00);
